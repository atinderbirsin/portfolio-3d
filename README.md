...
> Live preview: https://www.atinderbir.dev/
...
```bash
git clone https://github.com/atinderbirsin/portfolio-3d.git
cd portfolio-3d
```
...
- LinkedIn: https://www.linkedin.com/in/atinderbir-singh-187b7a221/
